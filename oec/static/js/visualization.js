...
function share(build){
  ...
  return function(){
    ...
    // set embed link
    d3.select(".modal-body input.embed_code").property("value", '<iframe width="560" height="315" src="https://atlas.media.mit.edu/'+lang+'/visualize/embed/'+build.url+'?controls=false" frameborder="0" ></iframe>')
