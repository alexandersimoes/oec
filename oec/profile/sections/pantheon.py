...
def make_pantheon_section(pantheon_id, attr):
    ...
    pantheon_cities_subtitle.append("<a target='_blank' href='http://pantheon.media.mit.edu/treemap/country_by_city/{}/all/-4000/2010/H15/pantheon/'>{} <i class='fa fa-external-link'></i></a>".format(pantheon_id, _("Explore on Pantheon")))
