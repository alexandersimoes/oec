...
class Country(Profile):
    ...
    def intro(self):
        ...
        if maritime_borders or land_borders:
            if maritime_borders and not land_borders:
                p4 = "{} is an island and borders {} by sea.".format(self.attr.get_name(), self.stringify_items(maritime_borders))
            if not maritime_borders and land_borders:
                p4 = "{} borders {}.".format(self.attr.get_name(), self.stringify_items(land_borders))
            if maritime_borders and land_borders:
                p4 = "{} borders {} by land and {} by sea.".format(self.attr.get_name(), self.stringify_items(land_borders), self.stringify_items(maritime_borders))
    ...
    def sections(self):
        ...
        trade_section = {
            "title": "{} Trade".format(self.attr.get_name()),
            "builds": [
        ...
        ps_section = {
            "title": "Export Opportunity in {}".format(self.attr.get_name()),
            "subtitle": subtitle,
            "builds": [
        ...
        pantheon_section = {
            "title": "Pantheon",
            "builds": [
                {"title": "Cultural Production of {}".format(self.attr.get_name()), "iframe": pantheon_iframe, "subtitle": "This treemap shows the cultural exports of {}, as proxied by the production of globally famous historical characters.".format(self.attr.get_name(), self.year)},
            ]
        }
