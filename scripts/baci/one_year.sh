...
for i in $(seq $1 $2); do
  ...
  if [[ $i -gt $ONE_YR_GROWTH ]]; then
    ...
    python $PWD/scripts/common/growth_calc.py $PWD/data/baci/$i/hs$3_yo.tsv.bz2 $PWD/data/baci/$PREV_YEAR/hs$3_yo.tsv.bz2 --years=1 --cols=export_val,import_val -o $PWD/data/baci/$i -r $3 -s top_export_hs4,top_import_hs4,top_export_hs6,top_import_hs6
  ...
  if [ $i -gt $FIVE_YR_GROWTH ]; then
    ...
    python $PWD/scripts/common/growth_calc.py $PWD/data/baci/$i/hs$3_yo.tsv.bz2 $PWD/data/baci/$PREV_YEAR_FIVE/hs$3_yo.tsv.bz2 --years=5 --cols=export_val,import_val -o $PWD/data/baci/$i -r $3 -s top_export_hs4,top_import_hs4,top_export_hs6,top_import_hs6
