...
export default class SectionExporters extends Component {

  render() {
    return (
      <section>
        <aside>
          <a name="Exporters" className="anchor"></a>
          <h2>Exporters</h2>
          <p>This treemap shows the share of countries that export Cadmium.</p>
          <p>
