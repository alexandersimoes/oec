...
class Permissions extends Component {
  ...
  render() {
    ...
    return (
      <content>
        <h1>{ t("Permissions") }</h1>
        <p>The observatory is published under a <a href="http://en.wikipedia.org/wiki/Wikipedia:Text_of_Creative_Commons_Attribution-ShareAlike_3.0_Unported_License">Creative Commons Attribution-Sharealike 3.0 Unported License</a>, so feel free to share the site and embed the apps anywhere on the internet. When doing so, please remember to attribute the site and its <a href="/about/">creators</a>.</p>
        ...
        <p>For more information, please contact <a href="mailto:oec@media.mit.edu">oec@media.mit.edu</a>.</p>

        <h2>Re-using and Contributing</h2>
        <p>The Observatory website is an open source platform built as part of the lead developer, Alexander Simoes' Master's Thesis at the MIT Media Lab. In being an open source project and leveraging the many technologies also available for fair use we welcome any and all collaborators to the project. Feel free to fork the site at: <a href="https://github.com/alexandersimoes/oec" className="wordwrap" title="Fork me on github">github.com/alexandersimoes/atlas_economic_complexity</a></p>
        <p>We also provide an <a href="/api">API</a> for the casual user interested in embedding their own Observatory app on any webpage.</p>
